...
module.exports = {
    ...
    ANTIWORD_WARN: process.env.ANTIWORD_WARN || '2',
    ...
    ANTISPAM_COUNT: process.env.ANTISPAM_COUNT || '1/3', // msgs/sec
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || 'Raganork~1ee6f39643e22f2f171da0dd78c3d986:434758786438355a4441453d').trim() || '',
    ...
    STICKER_DATA: process.env.STICKER_DATA || "echo",
    BOT_NAME: process.env.BOT_NAME || 'echo',
    ...
    HEROKU: {
        ...
        API_KEY: process.env.HEROKU_API_KEY || 'HRKU-544e6dc5-e6d6-474f-8636-08087d862866',
        APP_NAME: process.env.HEROKU_APP_NAME || 'echo'
    },
