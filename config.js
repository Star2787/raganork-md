...
module.exports = {
    ...
    BLOCK_CHAT: process.env.BLOCK_CHAT || 'on',
    PM_ANTISPAM: convertToBool(process.env.PM_ANTISPAM) || 'on',
    ...
    ANTIWORD_WARN: process.env.ANTIWORD_WARN || 'on',
    ...
    ANTI_BOT: process.env.ANTI_BOT || 'on',
    ANTISPAM_COUNT: process.env.ANTISPAM_COUNT || '2/3', // msgs/sec
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || 'Raganork~f6dd9bcfe4042191028509eaca799599:644d48655242666a5835413d').trim() || '',
    ...
    STICKER_DATA: process.env.STICKER_DATA || "flower",
    BOT_NAME: process.env.BOT_NAME || 'flower',
    ...
    TAKE_KEY: process.env.TAKE_KEY || 'on',
    MODE: process.env.MODE || 'public',
    WARN: process.env.WARN || '2',
    ANTILINK_WARN: process.env.ANTILINK_WARN || 'on',
    HEROKU: {
        HEROKU: process.env.HEROKU === undefined ? true : convertToBool(process.env.HEROKU),
        API_KEY: process.env.HEROKU_API_KEY || 'HRKU-5e3ed410-071b-4cf8-b057-56c6dd3355ca',
        APP_NAME: process.env.HEROKU_APP_NAME || 'flower-md'
    },
